...
class WSU_Student_Financial_Services_Give_Link_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			'Give Link',
			array(
				'description' => 'A "give" link to be displayed in the site footer',
			)
		);
	}
